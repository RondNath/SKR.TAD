...
#' @param SESSKRDataFrame SES of SKR parameters data frame (SES and significance)
...
#' @param slope_ref_TADs slope of a specific SKR used as a baseline (default: slope_ref_TADs = 1; skew-uniform slope)
#' @param intercept_ref_TADs intercept of a specific SKR used as a baseline (default: intercept_ref_TADs = 1.86; skew-uniform intercept)
#' @returns Plot of the SKR parameters values and significance
#' @export
#' @examples
#' head(SESSKRDataFrame)
#' GraphparamSKR(
