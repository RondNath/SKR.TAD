...
Based on an analysis of the Skewness-Kurtosis Relationship (SKR), this package  enables the study of the shapes of the Trait Abundance Distributions (TADs) to better understand community assembly processes, and predict community dynamics under environmental changes.
